...
# ROC AUC       : 0.8162
# MCC           : 0.3302
# Cohen's Kappa : 0.2491
# Avg Precision : 0.4009
# ==================================================
#
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/ML KAH/feature_correlations.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/ML KAH/class_distribution_resampling.png')
plt.close()
...
# Now fit this model with early stopping using the correct API
# In newer XGBoost versions, early_stopping_rounds is part of the callbacks
...
# For newer XGBoost versions, you can try using callbacks instead if needed
...
plt.legend()
plt.grid(True)
plt.savefig('/content/drive/MyDrive/ML KAH/threshold_optimization.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/ML KAH/model_evaluation_metrics.png', dpi=300, bbox_inches='tight')
plt.close()
...
joblib.dump(resampling_pipeline, '/content/drive/MyDrive/ML KAH/resampling_pipeline.joblib')
joblib.dump(final_threshold, '/content/drive/MyDrive/ML KAH/classification_threshold.joblib')
...
pd.DataFrame([experiment_results]).to_csv('/content/drive/MyDrive/ML KAH/hasil_eksperimen_recall_focus.csv', index=False)
